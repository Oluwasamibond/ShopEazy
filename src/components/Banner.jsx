          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
            ...
            >
              <img
                src={BannerImg}
                alt=""
                className="max-w-[400px] h-[350px] w-full mx-auto drop-shadow-[-10px_10px_12px_rgba(
                0,0,0,1)] rounded-lg object-cover"
              />
            </motion.div>
            {/* Detail section */}
            <motion.div 
            ...
            className="flex flex-col justify-center gap-6 sm:pt-0">
              ...
              <p className="text-sm text-gray-500 tracking-wide leading-5">
                ...
                quidem? consectetur adipisicing elit. Velit! dolor sit amet
                consectetur.
              </p>
